...
public class MipsEmulatorSC {
	...
	public SecureArray<GCSignal>[] getInstructionsMultiBanksGen(CompEnv<GCSignal> env, DataSegment instData, 
	...
	class GenRunnable extends network.Server implements Runnable {
		public void run() {
			try {
				...
				boolean[] containsRW = new boolean[inst.getDataLength()];
				SecureArray<GCSignal> instructionBank = null;
				if (MULTIPLE_BANKS){
					SecureArray<GCSignal>[] instructionBanks = getInstructionsMultiBanksGen(env, inst, containsRW, pcOffset);
