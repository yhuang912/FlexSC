...
public class CountCSCORAM extends ORAMCounterHarness{
	...
	public CountCSCORAM(int logN, int capacity, int dataSize, int securityParameter) {
	...
	class GenRunnable extends network.Server implements Runnable {
		...
		public void run() {
			try {
				listen(54321);
				CSCOramClient<Boolean> client = new CSCOramClient<Boolean>(is, os, N, dataSize, Party.Alice, capacity, Mode.COUNT, securityParameter);
				System.gc();
	...
	class EvaRunnable extends network.Client implements Runnable {
		...
		public void run() {
			try {
				...
				CSCOramServer<Boolean> server = new CSCOramServer<Boolean>(is, os, N, dataSize, Party.Bob, capacity, Mode.COUNT, securityParameter);
