...
public class ComputeCircuitSize {
	...
	public static void main(String[] args) throws Exception {
		...
		for(int log = base; log < base+num; log+=2) {


//			CountCircuitORAM  c1 = new CountCircuitORAM(log, 3, dataSize, 80);
//			CountCircuitORAMRecursion c1 = new CountCircuitORAMRecursion(log, 3, dataSize, 80, 128, 4);
...
//			CountCSCORAMRecursion c4 = new CountCSCORAMRecursion(log, 5, dataSize, 80, cutoff, recur);
//			CountCSCORAMRecursion   c4 = new CountCSCORAMRecursion(log, 4, dataSize, 80, cutoff, recur);
//			CountPathORAMNaive c4 = new CountPathORAMNaive(log, 2, dataSize, 80);
			//			CountPathORAMNaive c4 = new CountPathORAMNaive(log, 4, dataSize, 80);
			CountTreeORAM c4 = new CountTreeORAM(log, dataSize, 80);
...
//			System.out.print("PathSC="+Arrays.toString(y3[j])+"\n");
			System.out.print("SCORAM="+Arrays.toString(y4[j])+"\n");
