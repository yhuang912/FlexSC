...
public class CountPathORAMNaiveRecursion extends ORAMCounterHarness{
	int cutoff, recurFactor;
	public CountPathORAMNaiveRecursion(int logN, int capacity, int dataSize, int securityParameter, int cutoff, int recurFactor) {
	...
	public static void main(String [ ] args) throws Exception{
		CountPathORAMNaiveRecursion c = new CountPathORAMNaiveRecursion(10, 4, 10, 80, 5, 5);
		c.count();
