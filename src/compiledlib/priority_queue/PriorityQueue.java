...
public class PriorityQueue<T extends IWritable<T,Boolean>> {
	...
	public PriorityQueue(CompEnv<Boolean> env, IntegerLib<Boolean> lib, int m, T factoryT, CircuitOram<Boolean> poram) throws Exception {
		this.env = env;
		this.lib = lib;
		this.m = m;
	...
	public Boolean[] should_go_left(Boolean[] id, int level) throws Exception {
		...
		if(__tmp22) {
			...
			while(__tmp27) {
				...
				Boolean[] f_tmp_36 = env.inputOfAlice(Utils.fromInt(__tmp28, m));
				Boolean f_tmp_35 = lib.eq(tmpid, f_tmp_36);
				Boolean __tmp29 = f_tmp_35;
				Boolean[] f_tmp_38 = env.inputOfAlice(Utils.fromInt(i, m));
			...
			tmpid = id;
			Boolean[] f_tmp_46 = env.inputOfAlice(Utils.fromInt(level, m));
			...
			while(__tmp38) {
				...
				Boolean[] f_tmp_52 = env.inputOfAlice(Utils.fromInt(__tmp39, m));
				...
				Boolean[] f_tmp_57 = env.inputOfAlice(Utils.fromInt(__tmp43, m));
			...
			Boolean[] f_tmp_66 = env.inputOfAlice(Utils.fromInt(__tmp49, m));
			...
			Boolean[] f_tmp_73 = env.inputOfAlice(Utils.fromInt(__tmp54, m));
			Boolean[] f_tmp_72 = lib.and(tmpid,f_tmp_73);
			Boolean[] __tmp55 = f_tmp_72;
			int f_tmp_74 = 0;
			int __tmp56 = f_tmp_74;
			Boolean[] f_tmp_76 = env.inputOfAlice(Utils.fromInt(__tmp56, m));
	...
	public KeyValue<T> extractMax(Boolean[] dummy_bit) throws Exception {
		...
		Boolean[] f_tmp_97 = env.inputOfAlice(Utils.fromInt(__tmp71, m));
		...
		Boolean[] f_tmp_101 = env.inputOfAlice(Utils.fromInt(__tmp76, m));
		...
		Boolean[] f_tmp_107 = env.inputOfAlice(Utils.fromInt(__tmp81, m));
		...
		Boolean[] f_tmp_112 = env.inputOfAlice(Utils.fromInt(__tmp85, m));
	...
	public Boolean[] heapify(Boolean[] top_id, PriorityQueueNode<T> top_node, int level, Boolean[] dummy_bit) throws Exception {
		...
		Boolean[] child_iter = env.inputOfAlice(Utils.fromInt(0, m));
		Boolean[] id_to_use = env.inputOfAlice(Utils.fromInt(0, m));
		Boolean[] pos_to_use = env.inputOfAlice(Utils.fromInt(0, m));
	...
	public void insert(KeyValue<T> kv, Boolean[] dummy_bit) throws Exception {
		...
		Boolean[] f_tmp_410 = env.inputOfAlice(Utils.fromInt(__tmp363, m));
	...
	public Boolean[] insert_internal(KeyValue<T> kv, KeyValue<T> parent_kv, Boolean[] iter_id, Boolean[] iter_pos, int level, Boolean[] dummy_bit) throws Exception {
		...
		Boolean[] go_left = env.inputOfAlice(Utils.fromInt(0, 2));
		NodeId next = new NodeId(env, lib, m);
		Boolean[] newId = env.inputOfAlice(Utils.fromInt(0, m));
		int f_tmp_423 = 1;
		...
		if(__tmp379) {
			...
			Boolean[] f_tmp_522 = env.inputOfAlice(Utils.fromInt(__tmp468, m));
