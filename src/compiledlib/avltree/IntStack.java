...
public class IntStack {
	...
	public IntStack(CompEnv<Boolean> env, IntegerLib<Boolean> lib, int m, CircuitOram<Boolean> poram) throws Exception {
		this.env = env;
		this.lib = lib;
		this.m = m;
		this.poram = poram;
	...
	public Boolean[] stack_op(Boolean[] operand, Boolean op, Boolean dum) throws Exception {
		...
		IntStackNode r = new IntStackNode(env, lib, m);
		IntStackNode node = new IntStackNode(env, lib, m);
		...
		Boolean f_tmp_4 = lib.eq(dum, f_tmp_5);
		Boolean __tmp3 = f_tmp_4;
		Boolean f_tmp_6 = lib.and(__tmp1,__tmp3);
		...
		IntStackNode f_tmp_10 = new IntStackNode(env, lib, m).newObj(__tmp7.conditionalReadAndRemove(__tmp5, __tmp6, __tmp4));
		IntStackNode __tmp8 = f_tmp_10;
		IntStackNode f_tmp_11 = new IntStackNode(env, lib, m).newObj(lib.mux(r.getBits(), __tmp8.getBits(),__tmp4));
		...
		Boolean[] f_tmp_14 = lib.mux(__tmp11, __tmp10,__tmp4);
		...
		Boolean[] f_tmp_36 = lib.add(__tmp30,f_tmp_37);
		Boolean[] __tmp32 = f_tmp_36;
		Boolean[] f_tmp_38 = this.size;
		Boolean[] __tmp33 = f_tmp_38;
		Boolean[] f_tmp_39 = lib.mux(__tmp33, __tmp32,__tmp23);
		...
		Boolean f_tmp_44 = lib.not(__tmp22);
		Boolean __tmp39 = f_tmp_44;
		Boolean f_tmp_45 = lib.and(__tmp20,__tmp39);
