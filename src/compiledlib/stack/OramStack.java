...
public class OramStack<T extends IWritable<T,GCSignal>> {
	...
	public OramStack(CompEnv<GCSignal> env, IntegerLib<GCSignal> lib, T factoryT, SecureArray<GCSignal> data) throws Exception {
		this.env = env;
		this.lib = lib;
	...
	public T stack_op(T operand, GCSignal op) throws Exception {
		...
		GCSignal[] f_tmp_9 = lib.sub(__tmp6,f_tmp_10);
		GCSignal[] __tmp8 = f_tmp_9;
		GCSignal[] f_tmp_11 = this.size;
		GCSignal[] __tmp9 = f_tmp_11;
		GCSignal[] f_tmp_12 = lib.mux(__tmp9, __tmp8,__tmp1);
		GCSignal[] __tmp10 = f_tmp_12;
		this.size = __tmp10;
		GCSignal f_tmp_13 = lib.not(__tmp1);
		...
		GCSignal[] f_tmp_16 = lib.add(__tmp12,f_tmp_17);
		GCSignal[] __tmp14 = f_tmp_16;
		GCSignal[] f_tmp_18 = this.size;
		GCSignal[] __tmp15 = f_tmp_18;
		GCSignal[] f_tmp_19 = lib.mux(__tmp15, __tmp14,__tmp11);
