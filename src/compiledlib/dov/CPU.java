...
public class CPU implements IWritable<CPU, Boolean> {
	...
	public Boolean[] function(SecureArray<Boolean> reg, Boolean[] inst, Boolean[] pc) throws Exception {
		...
		Boolean[] f_tmp_168 = env.inputOfAlice(Utils.fromInt(__tmp143, 32));
		Boolean f_tmp_167 = intLib.eq(funct, f_tmp_168);
		Boolean __tmp144 = f_tmp_167;
		Boolean f_tmp_169 = intLib.and(__tmp142,__tmp144);
		Boolean __tmp145 = f_tmp_169;
