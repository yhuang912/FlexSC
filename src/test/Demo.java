...
public class Demo {
	public static void main(String[] args) throws NoSuchAlgorithmException {
		...
		// The engine's constructor (which handles all calls to the algorithm) auto-seeds
		// the new instance. Setting the seed is optional. See ISAACEngine.
		// Two instances will never (unless SecureRandom's getSeed method returns the same data)
		// return the same random data. Try running this demo twice and compare the output...
		//
